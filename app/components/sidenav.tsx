  ...
  return (
    <aside className={sidebarClass}>
      <div className={`flex h-full flex-col px-3 py-4 md:px-2 `}>
        <div className="mb-2 flex h-20 items-center justify-between gap-9 rounded-md bg-white p-4 ">
          <Link href="/">
...
export const SideNavDash = ({ toggleSidebar, isActive }) => {
  ...
  return (
    <aside className={sidebarClass}>
      <div className={`flex h-full flex-col px-3 py-4 md:px-2 `}>
        <div className=" mb-2 flex h-10 items-center justify-between rounded-md bg-white p-4 md:h-20">
          <Link href="/">
